...
namespace BinBalanceDataAccess.Models
{
    ...
    public partial class z_wm_BinCardReserve_GINOTCOMFIRM
    {
        [Key]
        ...
        public Guid? Ref_Wave_Index                                 {get;set;}
        public string Create_By                                      {get;set;}
        public Guid? Create_Date                                    {get;set;}
        public string Update_By                                      {get;set;}
        public Guid? Update_Date                                    {get;set;}
        public string Cancel_By                                      {get;set;}
        public Guid? Cancel_Date                                    {get;set;}
